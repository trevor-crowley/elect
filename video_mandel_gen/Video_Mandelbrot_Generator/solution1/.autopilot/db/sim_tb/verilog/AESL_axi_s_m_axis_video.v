...
module AESL_axi_s_m_axis_video (
    ...
    fifo #(480000, 24) fifo_m_axis_video_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(480000, 3) fifo_m_axis_video_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(480000, 3) fifo_m_axis_video_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(480000, 1) fifo_m_axis_video_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(480000, 1) fifo_m_axis_video_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(480000, 1) fifo_m_axis_video_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(480000, 1) fifo_m_axis_video_TDEST (
        .reset(1'b0),
        .write_clock(clk),
