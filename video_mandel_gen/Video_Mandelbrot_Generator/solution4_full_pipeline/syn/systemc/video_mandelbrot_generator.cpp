...
video_mandelbrot_generator::video_mandelbrot_generator(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    Loop_out_proc24_U0 = new Loop_out_proc24("Loop_out_proc24_U0");
    Loop_out_proc24_U0->ap_clk(ap_clk);
    Loop_out_proc24_U0->ap_rst(ap_rst_n_inv);
    Loop_out_proc24_U0->ap_start(Loop_out_proc24_U0_ap_start);
    Loop_out_proc24_U0->start_full_n(start_for_Mat2AXIvideo_U0_full_n);
    Loop_out_proc24_U0->ap_done(Loop_out_proc24_U0_ap_done);
    Loop_out_proc24_U0->ap_continue(Loop_out_proc24_U0_ap_continue);
    Loop_out_proc24_U0->ap_idle(Loop_out_proc24_U0_ap_idle);
    Loop_out_proc24_U0->ap_ready(Loop_out_proc24_U0_ap_ready);
    Loop_out_proc24_U0->start_out(Loop_out_proc24_U0_start_out);
    Loop_out_proc24_U0->start_write(Loop_out_proc24_U0_start_write);
    Loop_out_proc24_U0->img_0_data_stream_0_V_din(Loop_out_proc24_U0_img_0_data_stream_0_V_din);
    Loop_out_proc24_U0->img_0_data_stream_0_V_full_n(img_0_data_stream_0_full_n);
    Loop_out_proc24_U0->img_0_data_stream_0_V_write(Loop_out_proc24_U0_img_0_data_stream_0_V_write);
    Loop_out_proc24_U0->img_0_data_stream_1_V_din(Loop_out_proc24_U0_img_0_data_stream_1_V_din);
    Loop_out_proc24_U0->img_0_data_stream_1_V_full_n(img_0_data_stream_1_full_n);
    Loop_out_proc24_U0->img_0_data_stream_1_V_write(Loop_out_proc24_U0_img_0_data_stream_1_V_write);
    Loop_out_proc24_U0->img_0_data_stream_2_V_din(Loop_out_proc24_U0_img_0_data_stream_2_V_din);
    Loop_out_proc24_U0->img_0_data_stream_2_V_full_n(img_0_data_stream_2_full_n);
    Loop_out_proc24_U0->img_0_data_stream_2_V_write(Loop_out_proc24_U0_img_0_data_stream_2_V_write);
    Loop_out_proc24_U0->im_V(im_V);
    Loop_out_proc24_U0->re_V(re_V);
    Loop_out_proc24_U0->zoom_factor_V(zoom_factor_V);
    ...
    img_0_data_stream_0_U->if_din(Loop_out_proc24_U0_img_0_data_stream_0_V_din);
    img_0_data_stream_0_U->if_full_n(img_0_data_stream_0_full_n);
    img_0_data_stream_0_U->if_write(Loop_out_proc24_U0_img_0_data_stream_0_V_write);
    ...
    img_0_data_stream_1_U->if_din(Loop_out_proc24_U0_img_0_data_stream_1_V_din);
    img_0_data_stream_1_U->if_full_n(img_0_data_stream_1_full_n);
    img_0_data_stream_1_U->if_write(Loop_out_proc24_U0_img_0_data_stream_1_V_write);
    ...
    img_0_data_stream_2_U->if_din(Loop_out_proc24_U0_img_0_data_stream_2_V_din);
    img_0_data_stream_2_U->if_full_n(img_0_data_stream_2_full_n);
    img_0_data_stream_2_U->if_write(Loop_out_proc24_U0_img_0_data_stream_2_V_write);
    ...
    start_for_Mat2AXIvideo_U0_U->if_write(Loop_out_proc24_U0_start_write);
    ...
    SC_METHOD(thread_Loop_out_proc24_U0_ap_continue);

    SC_METHOD(thread_Loop_out_proc24_U0_ap_start);
    sensitive << ( ap_start );
    ...
    sensitive << ( Loop_out_proc24_U0_ap_idle );
    sensitive << ( Mat2AXIvideo_U0_ap_idle );

    SC_METHOD(thread_ap_ready);
    sensitive << ( Loop_out_proc24_U0_ap_ready );
    ...
    sc_trace(mVcdFile, Loop_out_proc24_U0_ap_start, "Loop_out_proc24_U0_ap_start");
    sc_trace(mVcdFile, Loop_out_proc24_U0_ap_done, "Loop_out_proc24_U0_ap_done");
    sc_trace(mVcdFile, Loop_out_proc24_U0_ap_continue, "Loop_out_proc24_U0_ap_continue");
    sc_trace(mVcdFile, Loop_out_proc24_U0_ap_idle, "Loop_out_proc24_U0_ap_idle");
    sc_trace(mVcdFile, Loop_out_proc24_U0_ap_ready, "Loop_out_proc24_U0_ap_ready");
    sc_trace(mVcdFile, Loop_out_proc24_U0_start_out, "Loop_out_proc24_U0_start_out");
    sc_trace(mVcdFile, Loop_out_proc24_U0_start_write, "Loop_out_proc24_U0_start_write");
    sc_trace(mVcdFile, Loop_out_proc24_U0_img_0_data_stream_0_V_din, "Loop_out_proc24_U0_img_0_data_stream_0_V_din");
    sc_trace(mVcdFile, Loop_out_proc24_U0_img_0_data_stream_0_V_write, "Loop_out_proc24_U0_img_0_data_stream_0_V_write");
    sc_trace(mVcdFile, Loop_out_proc24_U0_img_0_data_stream_1_V_din, "Loop_out_proc24_U0_img_0_data_stream_1_V_din");
    sc_trace(mVcdFile, Loop_out_proc24_U0_img_0_data_stream_1_V_write, "Loop_out_proc24_U0_img_0_data_stream_1_V_write");
    sc_trace(mVcdFile, Loop_out_proc24_U0_img_0_data_stream_2_V_din, "Loop_out_proc24_U0_img_0_data_stream_2_V_din");
    sc_trace(mVcdFile, Loop_out_proc24_U0_img_0_data_stream_2_V_write, "Loop_out_proc24_U0_img_0_data_stream_2_V_write");
...
void video_mandelbrot_generator::thread_Loop_out_proc24_U0_ap_continue() {
    Loop_out_proc24_U0_ap_continue = ap_const_logic_1;
}

void video_mandelbrot_generator::thread_Loop_out_proc24_U0_ap_start() {
    Loop_out_proc24_U0_ap_start = ap_start.read();
}
...
void video_mandelbrot_generator::thread_ap_idle() {
    ap_idle = (Loop_out_proc24_U0_ap_idle.read() & Mat2AXIvideo_U0_ap_idle.read());
}

void video_mandelbrot_generator::thread_ap_ready() {
    ap_ready = Loop_out_proc24_U0_ap_ready.read();
}
...
void video_mandelbrot_generator::thread_ap_sync_ready() {
    ap_sync_ready = Loop_out_proc24_U0_ap_ready.read();
}
